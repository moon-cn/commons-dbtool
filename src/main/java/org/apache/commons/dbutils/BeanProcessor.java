...
public class BeanProcessor {
     ...
     */
    protected static final Map<Class<?>, Object> PRIMITIVE_DEFAULTS = new HashMap<>();
     ...
     */
    protected void callSetter(final Object target, final PropertyDescriptor prop, Object value)
            throws SQLException {
     ...
     * @throws SQLException if a database error occurs.
     */
    protected  <T> T populateBean(final ResultSet resultSet, final T bean,
